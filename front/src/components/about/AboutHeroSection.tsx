    ...
    >
      ...
      <Container className="relative z-10 grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          >
            Tu camino hacia el <span className="text-primary">bienestar</span> y
            la superación
          </h1>

          <p className="mt-6 text-lg sm:text-xl font-sans text-text-muted leading-relaxed max-w-xl">
            En FitCore creemos que el fitness es mucho más que ejercicio físico:
            es una comunidad sólida, crecimiento personal constante y la
            construcción de un estilo de vida pleno y saludable.
          </p>
